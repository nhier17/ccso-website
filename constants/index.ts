...
export const FOCUS_AREAS = [
    {
      id: 1,
      title: "Food Security",
      description: "Enhancing agricultural skills and technologies to ensure food security.",
    ...
    },
    {
      id: 4,
      title: "Education",
      description: "Empowering communities through education and adult literacy programs.",
      icon: "/images/education.jpg",
    },
    {
      id: 5,
      title: "Empowerment",
      description: "Restoring dignity and self-respect through community-driven development.",
...
export const impactStories = [
  ...
  },
  {
    ...
    description:
      "We aim to provid access to clean and safe drinking water for over 1,000 families in Western Lakes State.",
  },
  {
...
export const footerLinks = {
  ...
  contactLinks: [
    ...
    { title: "Western Lakes State", icon: "/icons/map-pin.svg" },
...
export const supportOptions = [
  {
    ...
    description: "Help fund school supplies, teacher training, and scholarships for students in need.",
  ...
  },
  {
    ...
    description: "Provide safe drinking water by funding wells, filtration systems, and sanitation programs.",
  ...
  },
  {
    id: "food",
    title: "Food Security",
    description: "Support agricultural training, food distribution, and sustainable farming initiatives.",
  ...
  },
  {
    ...
    description: "Support initiatives that foster peace, reconciliation, and harmony among communities in South Sudan.",
...
export const otherSupportOptions = [
  {
    ...
    description: "Use your skills and time to help communities in need. Join our initiatives today.",
  ...
  },
  {
    ...
    description: "Collaborate with us to create long-term, sustainable impact in communities.",
    imageSrc: "/images/partner.png",
...
export const faqs= [
    {
      ...
      "answer": "CCSO (Christ Compassion Service Organization) is an indigenous South Sudanese non-governmental organization (NGO) committed to alleviating poverty, promoting sustainable livelihoods, and fostering peace and reconciliation in South Sudan."
    },
    {
      "question": "What is the mission of CCSO?",
      "answer": "CCSO's mission is to alleviate poverty among vulnerable communities in South Sudan and make them self-reliant through initiatives like food security, agricultural development, hygiene awareness, peacebuilding, and evangelism."
    },
    {
      "question": "What is the vision of CCSO?",
      "answer": "CCSO envisions a democratic, peaceful, and progressive South Sudan where all people have equal opportunities for human development without discrimination."
    },
    {
      "question": "Where does CCSO operate?",
      "answer": "CCSO primarily focuses on Western Lakes State in South Sudan but plans to expand its operations to other parts of the country in the future."
    },
    {
      "question": "What are the core values of CCSO?",
      "answer": "CCSO's core values include equality, transparency, accountability, grassroots participation, and the recognition of indigenous wisdom."
    },
    {
      "question": "What programs does CCSO offer?",
      "answer": "CCSO focuses on food security, agricultural development, hygiene and sanitation, disaster preparedness, peacebuilding, and evangelism."
    },
    {
      "question": "How does CCSO promote food security?",
      "answer": "CCSO enhances food security by transferring agricultural skills, promoting sustainable farming practices, and supporting agro-business groups."
    },
    {
      "question": "What is CCSO doing to promote peace and reconciliation?",
      "answer": "CCSO actively engages in peacebuilding initiatives to reduce inter-ethnic conflicts and promote harmony among South Sudanese communities."
    },
    {
      "question": "How does CCSO support education?",
      "answer": "CCSO encourages community participation in education, promotes adult literacy, and advocates for the education and welfare of the girl child."
    },
    {
      "question": "Does CCSO provide clean water?",
      "answer": "Yes, CCSO works to prevent waterborne diseases by providing safe drinking water and promoting hygiene and sanitation awareness."
    },
    {
      "question": "Can I partner with CCSO?",
      "answer": "Yes, CCSO invites partnerships with like-minded organizations, donors, and stakeholders to collaborate on impactful community programs."
    },
    {
      "question": "How can my organization collaborate with CCSO?",
      "answer": "Organizations can collaborate with CCSO by supporting its programs, sharing resources, or participating in joint initiatives aimed at community development."
    },
    {
      "question": "Does CCSO work with local governments?",
      "answer": "Yes, CCSO collaborates with county authorities, community leaders, and other stakeholders to enhance socio-economic development in South Sudan."
    },
    {
      "question": "How can I support CCSO?",
      "answer": "You can support CCSO by donating funds, volunteering, or partnering with the organization to implement its programs."
    },
    {
      "question": "Where do donations to CCSO go?",
      "answer": "Donations are used to fund CCSO's programs, including food security, agricultural development, peacebuilding, and community health initiatives."
    },
    {
      "question": "Is CCSO a non-profit organization?",
      "answer": "Yes, CCSO is a non-profit organization dedicated to serving vulnerable communities in South Sudan."
    },
    {
      "question": "Can I volunteer with CCSO?",
      "answer": "Yes, CCSO welcomes volunteers who can contribute their skills and time to support its initiatives."
    },
    {
      "question": "What kind of volunteer opportunities does CCSO offer?",
      "answer": "Volunteer opportunities include teaching, agricultural training, peacebuilding, hygiene awareness, and community mobilization."
    },
    {
      "question": "How can I get involved with CCSO’s work?",
      "answer": "You can get involved by volunteering, donating, or spreading awareness about CCSO’s mission and programs."
    },
    {
      "category": "Future Plans",
      "question": "What are CCSO’s future plans?",
      "answer": "CCSO plans to expand its operations to other parts of South Sudan, conduct situational assessments, and scale up its programs to reach more communities."
    },
